  ...
  const photos = [
    {
      ...
      src: "/assets/img/portfolio/23_20.webp",
    },
    {
      id: 2,
      order: 1,
      ...
      zIndex: 40,
      direction: "left" as Direction,
      src: "/assets/img/portfolio/tvh5.webp",
    },
    {
      id: 3,
      order: 2,
      ...
      src: "/assets/img/portfolio/23_25.webp",
    },
    {
      id: 4,
      order: 3,
      ...
      zIndex: 20,
      direction: "right" as Direction,
      src: "/assets/img/portfolio/19_3.webp",
    },
    {
      id: 5,
      order: 4,
      ...
      direction: "left" as Direction,
      src: "/assets/img/portfolio/19_6.webp",
    },
  ];
  ...
  return (
    <div className="mt-40 relative">
      ...
      <h3 className="z-20 mx-auto max-w-2xl justify-center bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 bg-clip-text py-3 text-center text-4xl text-transparent dark:bg-gradient-to-r dark:from-slate-100 dark:via-slate-200 dark:to-slate-100 dark:bg-clip-text md:text-7xl">
        Welcome to Our <span className="text-rose-500"> Gallery</span>
      </h3>
